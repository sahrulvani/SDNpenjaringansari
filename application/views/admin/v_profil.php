...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('index.php/welcome/index')?>">Beranda
            </a>
          </li>
  ...
  <section class="py-1">
    <div class="container">
      ...
      <p><h4 style="text-align:center">Deskripsi</h4></p>
      ...
      <p><h4 style="text-align:center">Deskripsi</h4></p>
      <img class="img-fluid d-block mx-auto" src="<?php echo base_url();?>assets/tik1.jpg">
      <p><h4 style="text-align:center">Deskripsi</h4></p>
